...
main(int argc, char *argv[]){
  ...
  12:	7ba50513          	addi	a0,a0,1978 # 7c8 <malloc+0xe6>
  16:	00000097          	auipc	ra,0x0
  1a:	614080e7          	jalr	1556(ra) # 62a <printf>
        exit(1);
  1e:	4505                	li	a0,1
  20:	00000097          	auipc	ra,0x0
  24:	290080e7          	jalr	656(ra) # 2b0 <exit>
    }
    else{
        sleep(atoi(argv[1]));
  28:	6588                	ld	a0,8(a1)
  2a:	00000097          	auipc	ra,0x0
  2e:	18c080e7          	jalr	396(ra) # 1b6 <atoi>
  32:	00000097          	auipc	ra,0x0
  36:	30e080e7          	jalr	782(ra) # 340 <sleep>
    }
    exit(0);
  3a:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 398:	4bc50513          	addi	a0,a0,1212 # 850 <digits>
 39c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 458:	3a4c8c93          	addi	s9,s9,932 # 7f8 <malloc+0x116>
 ...
 466:	3eeb8b93          	addi	s7,s7,1006 # 850 <digits>
 ...
 58c:	26898993          	addi	s3,s3,616 # 7f0 <malloc+0x10e>
        while(*s != 0){
 590:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 66e:	1fe7b783          	ld	a5,510(a5) # 868 <freep>
 ...
 696:	00e6ea63          	bltu	a3,a4,6aa <free+0x4a>
{
 ...
 6d8:	18f73a23          	sd	a5,404(a4) # 868 <freep>
}
 6dc:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 70a:	16253503          	ld	a0,354(a0) # 868 <freep>
 ...
 732:	13a90913          	addi	s2,s2,314 # 868 <freep>
  if(p == (char*)-1)
 736:	5afd                	li	s5,-1
 738:	a895                	j	7ac <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 73a:	00000797          	auipc	a5,0x0
 73e:	13678793          	addi	a5,a5,310 # 870 <base>
 ...
 76e:	0ea73f23          	sd	a0,254(a4) # 868 <freep>
      return (void*)(p + 1);
